  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen bg-gradient-to-r from-purple-300 to-pink-300">
        ...
        <div className="fixed bottom-0 left-0 w-full bg-gradient-to-r from-purple-200 to-pink-300 p-4 flex gap-2 border-t-0 rounded-full bg-gradient-to-r from-white to-gray-100">
          <Input
